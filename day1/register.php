...
<body>
    <section class="container">
        <?php
             if($t==1){
                echo '<h3 style="color:red; border: 1px solid white; background-color:yellow; border-radius:5px; padding:4px; text-align:center; margin-bottom:7px;">data inserted successfully</h3>';
             }
             if($t1==1){
